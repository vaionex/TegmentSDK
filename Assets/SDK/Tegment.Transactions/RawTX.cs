...
namespace Tegment.Transaction
{
    public static partial class RawTX
    {
        ...
        public static void RawTransaction(string _walletID, RawTXRequestDataArray[] _dataArray, string _authToken, System.Action<RequestException, ResponseHelper, RawTxResponseFormatter> callback, bool enableLog=false, string _serviceId = "")
        {
            if (enableLog)
