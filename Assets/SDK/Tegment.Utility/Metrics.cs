...
namespace Tegment.Utility
{
    public static partial class Metrics
    {
        ...
        public static void MetricsDetails(string _walletID, string _authToken, System.Action<RequestException, ResponseHelper, MetricsResponseFormatter> callback, bool enableLog = false)
        {
            if (enableLog)
