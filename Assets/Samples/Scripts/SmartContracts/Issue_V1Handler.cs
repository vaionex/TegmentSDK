...
namespace Tegment.Unity.Samples.SmartContracts
{
    ...
    /// </summary>
    public class Issue_V1Handler : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private TMP_InputField protocolID;
        [SerializeField]
        ...
        public void IssueV1_Submit()
        {
            ...
            Tegment.SmartContracts.Issue.MintIssue(_name.text, protocolID.text, symbol.text, description.text, image.text, tokenSupplyVal, decimalsVal, satsPerTokenVal,
                ...
                email_Issuer.text, schemaId_Meta.text, website_Meta.text, terms_Legal_Meta.text, URI_Media.text, type_Media.text, altURI_Media.text, splitable.isOn, data, protocol.text,
                reMinting.isOn, walletId.text, TegmentSessionHandler.Instance._authToken, Issue_V1CallBack, true);
        ...
        /// <param name="issueResponseFormatter"></param>
        private void Issue_V1CallBack(RequestException exception, ResponseHelper response, IssueResponseFormatter issueResponseFormatter)
        {
            responseText.text = response.Text;
        }
        /// <summary>
        /// reset the input controls and go back button click handler to main menu
        /// </summary>
